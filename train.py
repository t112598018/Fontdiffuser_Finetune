...
def main():
    ...
    # 載入預訓練模型
    unet.load_state_dict(torch.load(f"ckpt/unet.pth"))
    style_encoder.load_state_dict(torch.load(f"ckpt/style_encoder.pth"))
    content_encoder.load_state_dict(torch.load(f"ckpt/content_encoder.pth"))
